...
local function get_debugger_bundle()
  ...
  local debugger_jars = vim.fn.glob(debugger_path .. '/extension/server/com.microsoft.java.debug.plugin-*.jar')
...
return {
  ...
  config = function()
    ...
    local function get_jdtls_paths()
      ...
      paths.launcher_jar = vim.fn.glob(jdtls_install_path .. '/plugins/org.eclipse.equinox.launcher_*.jar')
    ...
    local function jdtls_setup()
      ...
      if cache_variables.capabilities == nil then cache_variables.capabilities = get_capabilities() end
