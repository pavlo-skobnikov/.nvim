return {
   ...
   },
   {
      ...
      config = function()
         ...
         -- Create a function to place the cursor in insert mode at the given
         -- position with optional form wrapping
         ...
         -- Common modes for different keymaps
         ...
         local keymaps = {
            ...
            ['cse('] = {
               get_place_cursor_fn('inner_start', '( ', ')'),
               'Wrap (element) & insert head',
            },
            ['cse)'] = {
               get_place_cursor_fn('inner_end', '(', ')'),
            ...
            -- Movement bindings
            ['E'] = {
               pe_api.move_to_next_element_tail,
               'Jump to next element tail',
               mode = move_modes,
            },
            ['W'] = {
               pe_api.move_to_next_element_head,
               'Jump to next element head',
               mode = move_modes,
            },
            ['B'] = {
               pe_api.move_to_prev_element_head,
               'Jump to previous element head',
               mode = move_modes,
            },
            ['gE'] = {
               pe_api.move_to_prev_element_tail,
               'Jump to previous element tail',
               mode = move_modes,
            },

            ['('] = {
               pe_api.move_to_parent_form_start,
               "Jump to parent form's head",
               mode = move_modes,
            },
            [')'] = {
               pe_api.move_to_parent_form_end,
            ...
            ['aF'] = {
               pe_api.select_around_top_level_form,
